...
<div id="mc_embed_signup">
    <form action="https://mit.us21.list-manage.com/subscribe/post?u=a5e31fd822657f0bd40c253f0&amp;id=426d807ab8&amp;f_id=0010d5e1f0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
...
<div class="mc-field-group">
    ...
    <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_a5e31fd822657f0bd40c253f0_426d807ab8" tabindex="-1" value=""></div>
        <div class="optionalParent">
            <div class="clear foot">
                <input type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe" class="button">
                <p class="brandingLogo"><a href="http://eepurl.com/ih3AuH" title="Mailchimp - email marketing made easy and fun"><img src="https://eep.io/mc-cdn-images/template_images/branding_logo_text_dark_dtp.svg"></a></p>
            </div>
        </div>
    </div>
</form>
